                ...
                <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                    ...
                    <div class="card card-plain">
                        <div class="card-header pb-0 text-start">
                            <h4 class="font-weight-bolder">Sign In to Teacher</h4>
                            <p class="mb-0">Enter your email and password to sign in</p>
                        </div>
                        @include('sweetalert::alert')
                        <div class="card-body">
                            <form action="{{ route('dosen.auth-signin-post') }}" method="POST" role="form">
                                @csrf

                                <div class="mb-3">
                                    <input type="text" class="form-control form-control-lg" name="login" placeholder="NIDN / Phone Number / Email Adress ..." aria-label="Email">
                                    @error('login')
