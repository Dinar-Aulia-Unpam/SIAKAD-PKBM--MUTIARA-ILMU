        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                    ...
                    <div class="card card-plain">
                        <div class="card-header pb-0 text-start">
                            <h4 class="font-weight-bolder">Sign In to Admin</h4>
                            <p class="mb-0">Enter your email and password to sign in</p>
                        </div>
                        @include('sweetalert::alert')
                        <div class="card-body">
                            <form action="{{ route('admin.auth-signin-post') }}" method="POST" role="form">
                                @csrf
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <p class="mb-0 text-sm mx-auto">
                                Lost an password?
                                <a href="{{ route('admin.auth-forgot-page') }}" class="text-primary text-gradient font-weight-bold">Come Here</a>
                            </p>
                            <p class="mb-0 text-sm mx-auto">
                                Back to home?
                ...
                <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                    <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('{{ asset('auth/assets/img/amdev2.png') }}'); background-size: cover;">
