...
@section('title')
    Kelola Tugas - Siakad By PKBM Mutiara Ilmu
@endsection
@section('menu')
    Kelola Tugas
@endsection
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-4 col-12">
                                ...
                                <input type="time" id="exp_time" name="exp_time" class="form-control">
                                @error('exp_time')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <input type="text" id="title" name="title" class="form-control" placeholder="Masukkan nama judul tugas...">
                                @error('title')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <textarea name="detail_task" id="summernote" cols="30" rows="10" class="form-control" placeholder="Inputkan detail tugas..."></textarea>
                                @error('detail_task')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
