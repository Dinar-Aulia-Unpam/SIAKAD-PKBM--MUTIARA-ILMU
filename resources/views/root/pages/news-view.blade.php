...
<div class="page-content row">
    ...
    <div class="col-lg-4 col-12">
        <div class="card mb-3">
            <div class="card-body">
                <h4 class="card-title text-center">Kata Sambutan</h4>
                <img src="{{ asset('storage/images/default/default-profile.jpg') }}" class="card-img-top mb-2" alt="">
                <p class="text-center">Selamat datang di PKBM Mutiara Ilmu,<br>Drs. Alfaza Natayo, S.Tek<br>Rektor Utama</p>
                <hr>
                <p style="text-align: justify">Kami sangat senang bisa menyambut Anda di PKBM Mutiara Ilmu. Kami berkomitmen untuk memberikan pendidikan berkualitas dan pengalaman belajar yang bermakna bagi setiap mahasiswa. Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore dolore laboriosam praesentium quas voluptatem ab facere repellendus reiciendis, fuga odio sequi. Nisi architecto totam eaque magnam hic cum aperiam commodi.</p>
            </div>
