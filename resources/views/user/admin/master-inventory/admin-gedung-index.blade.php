...
@section('title')
    Data Master Gedung - Siakad By PKBM Mutiara Ilmu
@endsection
@section('menu')
    Data Master Gedung
@endsection
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center align-items-center">
                                    ...
                                    <form id="delete-form-{{ $item->code }}"
                                        action="{{ route($prefix.'inventory.gedung-destroy', $item->code) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                            data-original-title="Delete"
                                            data-url="{{ route($prefix.'inventory.gedung-destroy', $item->code) }}"
                                            data-name="{{ $item->name }}"
