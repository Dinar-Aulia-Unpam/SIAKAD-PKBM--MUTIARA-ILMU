...
@section('title')
    Data Master Kurikulum - Siakad By PKBM Mutiara Ilmu
@endsection
@section('menu')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <label for="code">Kode Kurikulum ( 3 Huruf Kapital )</label>
                                <input type="text" class="form-control" name="code" id="code" placeholder="Inputkan kode kurikulum..." value="{{ $item->code }}" maxlength="3" uppercase onkeydown="return /[a-zA-Z0-9]/i.test(event.key)" >
                                @error('code')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-12">
                                <label for="desc">Deskripsi Kurikulum</label>
                                <textarea name="desc" id="desc" class="form-control" cols="30" rows="10">{{ $item->desc == null ? 'Inputkan deskripsi kurikulum' : $item->desc }}</textarea>
                                @error('desc')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
